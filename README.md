...
<div>
  ...
  <h1>Who am I?</h1>
  <p>
  Hello 👋 My name is Juan Martin Mendoza.
I'm a Mechanical Engineering Student at the Buenos Aires University, Argentina. Following my passion for programming, I've completed the Soy Henry bootcamp and graduated as Full stack Developer🚀.
I'm passionate about programming and solving the problems that this field presents. </p>


  <h3>Full Stack Web Developer</h3>
  <p>
    I have solid knowledge about web development.
  ...
  <ul>
    ...
    <li>
      Global states management using React Redux.
    </li>
    <li>Interactive interface creation using React</li>
    <li>
      Server development using Node.js and
      Express.js.
    </li>
...
Estoy buscando aplicar en el desarrollo Web. </p>
  ...
  <h4>Let's develop amazing things together!🫱🏽‍🫲🏻</h4>
